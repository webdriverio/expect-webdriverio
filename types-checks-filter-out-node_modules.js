...
const excludeList = [
    ...
    'node_modules/@wdio/types/build/Capabilities.d.ts',
    'node_modules/@wdio/types/build/index.d.ts',
    'node_modules/webdriverio/node_modules/@wdio/types/build/index.d.ts',
    // Add more paths or patterns as needed
]

// Specific error messages to exclude (all conditions in a tuple must match via `includes`)
const excludeErrors = [
    // @types/jasmine is not in scope for tsconfig.types.json, so Expected type is unresolved
