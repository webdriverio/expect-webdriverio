...
describe('WebdriverIO Custom Matchers', () => {
    ...
    describe('Browser matchers', () => {
        it('should verify browser title', async () => {
            // @ts-expect-error -- toHaveTitle is not recognized properly fix incoming
            await expect(browser).toHaveTitle('WebdriverIO · Next-gen browser and mobile automation test framework for Node.js | WebdriverIO')
        })

        it('should verify browser title contains text', async () => {
            // @ts-expect-error -- toHaveTitle with stringContaining is not recognized properly fix incoming
            await expect(browser).toHaveTitle(expect.stringContaining('WebdriverIO'))
        })

        it('should verify browser URL', async () => {
            // @ts-expect-error -- toHaveUrl is not recognized properly fix incoming
    ...
    describe('Element existence matchers', () => {
        it('should verify element exists', async () => {
            ...
            // @ts-expect-error -- toBeExisting is not recognized properly fix incoming
        ...
        it('should verify element does not exist', async () => {
            ...
            // @ts-expect-error -- not.toExist is not recognized properly fix incoming
    ...
    describe('Element visibility matchers', () => {
        ...
        it('should verify element is displayed in viewport', async () => {
            const searchButton = await $('.DocSearch-Button')
            // @ts-expect-error -- toBeDisplayedInViewport is not recognized properly fix incoming
    ...
    describe('Element state matchers', () => {
        ...
        it('should verify element is enabled', async () => {
            const searchButton = await $('.DocSearch-Button')
            // @ts-expect-error -- toBeEnabled is not recognized properly fix incoming
            await expect(searchButton).toBeEnabled()
        })

        it('should verify button is not disabled', async () => {
            const searchButton = await $('.DocSearch-Button')
            // @ts-expect-error -- not.toBeDisabled is not recognized properly fix incoming
    ...
    describe('Element text matchers', () => {
        it('should verify element text', async () => {
            ...
            // @ts-expect-error -- toHaveText is not recognized properly fix incoming
        ...
        it('should verify text with options', async () => {
            const heading = await $$('h1')[1]  // Second h1 has text
            // @ts-expect-error -- toHaveText with options is not recognized properly fix incoming
    ...
    describe('Element attribute matchers', () => {
        it('should verify element has attribute', async () => {
            ...
            // @ts-expect-error -- toHaveAttribute is not recognized properly fix incoming
        ...
        it('should verify element has class', async () => {
            const searchButton = await $('.DocSearch-Button')
            // @ts-expect-error -- toHaveElementClass is not recognized properly fix incoming
            await expect(searchButton).toHaveElementClass('DocSearch-Button')
        })

        it('should verify element has multiple classes', async () => {
            const searchButton = await $('.DocSearch-Button')
            // @ts-expect-error -- toHaveElementClass with array is not recognized properly fix incoming
    ...
    describe('Element property matchers', () => {
        it('should verify element property', async () => {
            const searchButton = await $('.DocSearch-Button')
            // @ts-expect-error -- toHaveElementProperty is not recognized properly fix incoming
    ...
    describe('Element value matchers', () => {
        it('should verify input value', async () => {
            ...
            // @ts-expect-error -- toHaveValue is not recognized properly fix incoming
        ...
        it('should verify value contains text', async () => {
            ...
            // @ts-expect-error -- toHaveValue with stringContaining is not recognized properly fix incoming
    ...
    describe('Elements array matchers', () => {
        it('should verify elements array size', async () => {
            ...
            // @ts-expect-error -- toBeElementsArrayOfSize is not recognized properly fix incoming
            await expect(navLinks).toBeElementsArrayOfSize(49)
        })

        it('should verify elements array size with comparison', async () => {
            const navLinks = await $$('nav a')
            // @ts-expect-error -- toBeElementsArrayOfSize with comparison is not recognized properly fix incoming
    ...
    describe('Focus matchers', () => {
        it('should verify element is focused', async () => {
            ...
            if (await searchInput.isExisting()) {
                // @ts-expect-error -- toBeFocused is not recognized properly fix incoming
    ...
    describe('With wait options', () => {
        it('should wait for condition to be met', async () => {
            ...
            // @ts-expect-error -- toBeDisplayed with wait option is not recognized properly fix incoming
            await expect(heading).toBeDisplayed({ wait: 5000 })
        })

        it('should use custom interval', async () => {
            const nav = await $('nav')
            // @ts-expect-error -- toExist with wait and interval options is not recognized properly fix incoming
    ...
    describe('Negated matchers', () => {
        it('should work with not', async () => {
            ...
            // @ts-expect-error -- not.toBeDisplayed is not recognized properly fix incoming
