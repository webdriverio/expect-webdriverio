...
import { isElementArrayOrChainable } from './elementsUtil.js'
...
export const refetchElements = async (
    ...
    if (elements && wait > 0 && (elements.length === 0 || full) && isElementArrayOrChainable(elements) && elements.foundWith in elements.parent) {
