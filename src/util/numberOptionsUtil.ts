...
export function validateNumberOptions(expectedValue: number | ExpectWebdriverIO.NumberOptions): { numberMatcher: ExpectWebdriverIO.NumberOptions, numberCommandOptions?: ExpectWebdriverIO.CommandOptions } {
    if (isNumber(expectedValue)) {
        return { numberMatcher: { eq: expectedValue }, numberCommandOptions: undefined }
        ...
        return { numberMatcher: { eq, gte, lte }, numberCommandOptions: commandOptions }
    }
}
